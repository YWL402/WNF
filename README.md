...
### 直接下载 (推荐)
1. 从 [Releases](../../releases) 下载最新版本的 `窝囊废Desk 1.0.0.exe`
2. 双击运行即可使用（便携版，无需安装）
...
1. **精确计算**：设置准确的工作时间可获得更精确的收入计算
2. **多风格**：右键托盘选择不同风格适应不同心情
3. **快捷键**：使用Ctrl+H快速显示/隐藏窗口
4. **托盘提示**：鼠标悬停托盘图标查看详细信息
5. **自启动**：可将程序加入系统启动项实现开机自启
